    ...
    <div className="min-h-[calc(100vh-4rem)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <AnimatedSection delay={100} className="mb-12">
          <div className="prose prose-base sm:prose-lg mx-auto text-gray-300">
        ...
        <AnimatedSection delay={200}>
          ...
          <div className="mb-12 py-2">
            ...
            <div className="relative">
              ...
              >
                <div className="flex gap-4 min-w-max py-2">
                  {softwareSkills.map((skill, index) => (
                    ...
                    >
                      <div className="glass-habit glass-habit-hover flex flex-col items-center p-5 sm:p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 transition-all duration-300 group w-28 sm:w-36">
                        <div className="w-14 h-14 sm:w-16 sm:h-16 mb-3 flex items-center justify-center bg-[#0d0c22] rounded-2xl p-3 shadow-lg group-hover:bg-white/5 transition-all duration-300">
                          <img
                            src={skill.icon}
                            alt={skill.name}
                        ...
                        <span className="text-[12px] sm:text-sm font-bold text-gray-200 text-center leading-tight max-w-full truncate group-hover:text-blue-400 transition-colors duration-300">
                          {skill.name}
                        </span>
                      </div>
                    </AnimatedSection>
              ...
              <div
                className="absolute top-0 left-0 bottom-0 w-16 sm:w-24 pointer-events-none z-10 block"
                style={{
                  background:
                    "linear-gradient(to right, #02030a 0%, rgba(2, 3, 10, 0.8) 40%, rgba(2, 3, 10, 0) 100%)",
                }}
              ></div>
              {/* Right fade overlay - Dark mode */}
              <div
                className="absolute top-0 right-0 bottom-0 w-16 sm:w-24 pointer-events-none z-10 block"
                style={{
                  background:
                    "linear-gradient(to left, #02030a 0%, rgba(2, 3, 10, 0.8) 40%, rgba(2, 3, 10, 0) 100%)",
                }}
              ></div>
            </div>
          </div>
        ...
        <AnimatedSection delay={400} className="mt-16">
          <div className="glass-habit p-4 sm:p-6 border border-white/5">
            ...
            {/* Education Timeline */}
            <div className="relative pl-8 space-y-6 sm:space-y-8 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/10">

              {/* Bachelor's */}
              <div className="relative">
                <div className="absolute -left-8 mt-1.5 w-6 h-6 rounded-full border-4 border-[#02030a] bg-blue-600 z-10 box-content"></div>
              ...
              {/* Diploma */}
              <div className="relative">
                <div className="absolute -left-8 mt-1.5 w-6 h-6 rounded-full border-4 border-[#02030a] bg-violet-600 z-10 box-content"></div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1">
                  <h4 className="text-base sm:text-lg font-bold text-white">
              ...
              {/* SSC */}
              <div className="relative">
                <div className="absolute -left-8 mt-1.5 w-6 h-6 rounded-full border-4 border-[#02030a] bg-gray-600 z-10 box-content"></div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1">
                  <h4 className="text-base sm:text-lg font-bold text-white">
